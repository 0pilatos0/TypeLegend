...
export class DateUtils {
  ...
  static isBefore: typeof isBefore = isBefore;
  static subtractDays: typeof subtractDays = subtractDays;
  static differenceInWeeks: typeof differenceInWeeks = differenceInWeeks;
